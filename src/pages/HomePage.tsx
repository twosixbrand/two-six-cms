...
import {
  ...
  FiRotateCcw, FiInbox, FiFileText, FiRss, FiFacebook
} from 'react-icons/fi';
...
const homeSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/consignment/dispatches', icon: <FiTruck />, title: 'Despachos (QR)', desc: 'Envio de prendas con validacion QR.', permission: 'sales.reports.view' },
      { path: '/consignment/sellout', icon: <FiFileText />, title: 'Procesar Sell-out', desc: 'Carga de ventas, descuento de stock y facturacion DIAN.', permission: 'sales.reports.view' },
      { path: '/consignment/sell-reports', icon: <FiInbox />, title: 'Ventas del Cliente', desc: 'Reportes de venta enviados por aliados.', permission: 'sales.reports.view' },
      { path: '/consignment/returns', icon: <FiRotateCcw />, title: 'Devoluciones / Garantias', desc: 'Devoluciones por portafolio, garantia o post-venta.', permission: 'sales.reports.view' },
      { path: '/consignment/cycle-counts', icon: <FiClipboard />, title: 'Conteos Ciclicos / Merma', desc: 'Conciliacion de inventario y facturacion de merma.', permission: 'sales.reports.view' },
  ...
  },
  {
    ...
    items: [
      { path: '/google-merchant-feed', icon: <FiRss />, title: 'Google Merchant Feed', desc: 'Dashboard del feed XML para Google Merchant Center.', permission: 'sales.reports.view' },
      { path: '/facebook-feed', icon: <FiFacebook />, title: 'Facebook Feed', desc: 'Dashboard del feed para Facebook Commerce.', permission: 'sales.reports.view' },
    ]
  },
  {
