...
const DianDocumentationPage = () => {
    return (
        <div className="card" style={{ maxWidth: '1200px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
            <h1 className="pe-title" style={{ fontSize: '28px', marginBottom: '8px', color: '#1a1a1a', fontWeight: 'bold' }}>Documentación Técnica: Facturación Electrónica DIAN</h1>
            <p className="pe-desc" style={{ marginBottom: '32px', color: '#666', fontSize: '15px' }}>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
                ...
                <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaProjectDiagram className="mr-2 text-yellow-500" /> 1. Arquitectura del Flujo DIAN</h2>
                    <p className="text-gray-600 mb-6 text-sm">El proceso inicia cuando un pedido cambia a estado <b>PAGADO</b> o cuando el administrador presiona el botón "REINTENTAR DIAN". El Backend (NestJS) se encarga de todo el ciclo de vida.</p>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between bg-gray-50 p-4 rounded-lg">
                        <div className="flex flex-col items-center p-3 text-center w-full">
                            ...
                            <span className="text-xs text-gray-500">(Dispara Evento)</span>
                        </div>
                        <div className="hidden md:block w-8 border-t border-dashed border-gray-400"></div>
                        <div className="flex flex-col items-center p-3 text-center w-full">
                            <div className="w-12 h-12 bg-white border-2 border-black text-black rounded-full flex items-center justify-center mb-2"><FaFileInvoice size={20}/></div>
                            <span className="text-xs font-semibold">Motor UBL 2.1</span>
                            <span className="text-xs text-gray-500">(Arma XML)</span>
                        </div>
                        <div className="hidden md:block w-8 border-t border-dashed border-gray-400"></div>
                        <div className="flex flex-col items-center p-3 text-center w-full">
                            <div className="w-12 h-12 bg-yellow-500 text-black rounded-full flex items-center justify-center mb-2"><FaShieldAlt size={20}/></div>
                        ...
                        <div className="flex flex-col items-center p-3 text-center w-full">
                            ...
                            <span className="text-xs text-gray-500">(Wcf SOAP)</span>
                        </div>
                        <div className="hidden md:block w-8 border-t border-dashed border-gray-400"></div>
                        <div className="flex flex-col items-center p-3 text-center w-full">
                            ...
                            <span className="text-xs text-gray-500">(ZipKey Async)</span>
                        </div>
                    </div>
                </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* 2. UBL */}
                    <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaFileInvoice className="mr-2 text-blue-500" /> 2. Estándar UBL 2.1</h2>
                    ...
                    {/* 3. XAdES */}
                    <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaShieldAlt className="mr-2 text-yellow-500" /> 3. Firma Digital XAdES</h2>
                        <ul className="list-disc pl-5 text-gray-600 text-sm space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     {/* 4. SOAP & Notas */}
                     <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaServer className="mr-2 text-purple-600" /> 4. SOAP y Notas (NC/ND)</h2>
                        <ul className="list-disc pl-5 text-gray-600 text-sm space-y-2">
                    ...
                    {/* 5. PDF y Gráficos */}
                    <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaFilePdf className="mr-2 text-red-500" /> 5. Renderizado Premium PDF</h2>
                        <ul className="list-disc pl-5 text-gray-600 text-sm space-y-2">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8">
                    <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                        <h2 className="text-xl font-bold flex items-center text-black mb-4"><FaServer className="mr-2 text-green-500" /> 6. Motor Autónomo de Correos (Zero-Touch)</h2>
                        <ul className="list-disc pl-5 text-gray-600 text-sm space-y-2">
